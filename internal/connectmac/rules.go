...
func DefaultRulesTemplate() string {
	return strings.Join([]string{
		...
		"9. A pending but empty Dedicated Host may be previewed and attempted with explicit confirmation; if AWS rejects RunInstances, report that exact reason and stop.",
...
func DefaultSkillTemplate() string {
	return strings.Join([]string{
		...
		"- A pending but empty Dedicated Host may be previewed and attempted with explicit confirmation; if AWS rejects RunInstances, report that exact reason and stop.",
