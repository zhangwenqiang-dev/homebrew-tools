...
- [x] **Step 1: Add a failing runner contract test**
...
- [x] **Step 2: Run the focused test and confirm the interface method is missing**
...
- [x] **Step 3: Implement streamed execution**
...
- [x] **Step 1: Write failing job-state tests**
...
- [x] **Step 2: Write failing progress parser tests**
...
- [x] **Step 3: Implement focused job types and manager**
...
- [x] **Step 4: Initialize shared state**
...
- [x] **Step 2: Replace synchronous push/pull handlers**
...
- [x] **Step 1: Add failing activity-check tests**
...
- [x] **Step 1: Add transfer job state to the page**
...
- [x] **Step 3: Restore jobs after navigation or refresh**
...
- [x] **Step 4: Prevent duplicate clicks**
...
- [x] **Step 3: Run browser-level checks**
...
- [x] **Step 4: Review scope and worktree**
